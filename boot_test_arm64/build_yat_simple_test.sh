...
SCRIPT_DIR="$WORK_DIR/boot_test_arm64"
TEST_DIR="$WORK_DIR/yat_simple_test_env_arm64"
...
echo "编译测试程序..."
cd "$SCRIPT_DIR"
aarch64-linux-gnu-gcc -static -o yat_simple_test yat_simple_test.c 2>/dev/null || \
